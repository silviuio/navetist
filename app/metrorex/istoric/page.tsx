    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-zinc-500 text-xs">Istoric prețuri</span>
        </div>
        <h1 className="text-2xl font-bold text-white mb-1">
          Evoluția prețului biletului de metrou
        </h1>
        <p className="text-gray-400 text-sm max-w-xl">
          Prețul unei călătorii la metroul din București din 2000 până în prezent,
          inclusiv majorarea anunțată pentru mai 2026.
        </p>
      </div>
