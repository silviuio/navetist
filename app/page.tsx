      ...
      <div className="mb-10">
        <div className="flex items-start justify-between gap-4 mb-2">
          ...
          <Link
            ...
            className="shrink-0 inline-flex items-center gap-2 text-sm text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white transition-colors mt-2"
          >
